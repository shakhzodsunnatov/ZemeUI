...
struct ApplicationProgress: View {
...
extension ApplicationProgress {
    ...
    private func getWidthOfProgressPercent(completeUntil: Int, geo: GeometryProxy) -> CGFloat {
        ...
        case 3: return geo.size.width * CGFloat(0.5)
        case 4: return geo.size.width * CGFloat(0.7)
        case 5: return geo.size.width * CGFloat(1)
