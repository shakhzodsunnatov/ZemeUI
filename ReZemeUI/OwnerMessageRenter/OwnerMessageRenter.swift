...
struct OwnerMessageRenter: View {
    ...
    var body: some View {
        NavigationNavBar(title: "Message Renter", type: .OWNER) {
...
extension OwnerMessageRenter: AgentChatTypesProtocol {
...
struct OwnerMessageRenter_Previews: PreviewProvider {
