...
struct OwnerRequestDetail: View {
    ...
    var body: some View {
        ...
        .navigationOwner(title: "New Service Request")
...
struct OwnerRequestDetail_Previews: PreviewProvider {
